  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-10">
      ...
      <div className="relative max-w-[1100px] mx-auto w-full">
        ...
        >
          <span className="block" style={{ fontSize: "clamp(2.6rem, 7vw, 6.2rem)" }}>
            Spacetime <span className="italic font-light text-white/70">&amp;</span>
          </span>
          <span className="block" style={{ fontSize: "clamp(2.6rem, 7vw, 6.2rem)" }}>
            Energy-Matter
            <span
              className="font-mono text-plasma/70 align-middle ml-3 md:ml-5"
              style={{ fontSize: "0.32em", letterSpacing: "0.2em" }}
            >
              (STEM)
            </span>
          </span>
      ...
      <div className="hidden lg:flex absolute right-10 bottom-10 flex-col items-end gap-1 font-mono text-[10px] tracking-[0.2em] uppercase text-white/35">
        <div>Bern · 1905 &nbsp;◇&nbsp; Berlin · 1915</div>
        <div className="text-plasma/55">E = mc² &nbsp;·&nbsp; Gμν = 8πTμν</div>
      </div>
    </section>
  );
}
